...
class FailedScanRepository(BaseRepository[FailedScan]):
    ...
    def list_by_repo(self, repo_id: str | ObjectId, status: ScanStatus, skip: int = 0, limit: int = 20) -> List[FailedScan]:
    ...
    def update(self, failed_scan_id: str | ObjectId, data: dict) -> Optional[FailedScan]:
